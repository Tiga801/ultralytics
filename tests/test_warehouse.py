...
=======
        assert default_config.engine_name == "easyair-terminal"
        assert default_config.engine_version == "2.0.0.0"
        assert default_config.engine_port == 8555
        assert default_config.algo_category == "other"
>>>>>>> 07331326 (feat: build video analytics task management system)
...
=======
        assert caps.resolution_cap == (300, 5000)
>>>>>>> 07331326 (feat: build video analytics task management system)
...
=======
        assert payload["algoCategory"] == "other"
>>>>>>> 07331326 (feat: build video analytics task management system)
